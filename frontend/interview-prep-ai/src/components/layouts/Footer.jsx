    ...
    <footer className="bg-white border-t border-gray-200 py-8 mt-12">
      <div className="container mx-auto px-4 text-center text-sm text-gray-600 space-y-4">
        ...
        <div className="flex justify-center gap-6 flex-wrap text-orange-600 font-semibold">
          ...
          <a href="https://www.linkedin.com/in/krishna-rana-330a32363/" target="_blank" rel="noopener noreferrer" className="hover:underline">LinkedIn</a>
          <a href="mailto:krishnarana.work@gmail.com" className="hover:underline">Email</a>
        </div>
      </div>
    </footer>
  );
